    ...
    AF::F: BinomiallyExtendable<D>,
{
    ...
    fn zero() -> Self {
        Self { value: field_to_array::<AF, D>(AF::zero()) }
    }
    fn one() -> Self {
        Self { value: field_to_array::<AF, D>(AF::one()) }
    }
    fn two() -> Self {
        Self { value: field_to_array::<AF, D>(AF::two()) }
    }
    fn neg_one() -> Self {
        Self { value: field_to_array::<AF, D>(AF::neg_one()) }
    }
    ...
    fn square(&self) -> Self {
        match D {
            ...
            3 => Self { value: cubic_square(&self.value, AF::F::w()).to_vec().try_into().unwrap() },
    ...
    AF::F: BinomiallyExtendable<D>,
{
    fn sum<I: Iterator<Item = Self>>(iter: I) -> Self {
        let zero = Self { value: field_to_array::<AF, D>(AF::zero()) };
    ...
    AF::F: BinomiallyExtendable<D>,
{
    ...
    fn mul(self, rhs: Self) -> Self {
        ...
        match D {
            ...
            3 => Self { value: cubic_mul(&a, &b, w).to_vec().try_into().unwrap() },
            _ => {
                let mut res = Self::default();
    ...
    AF::F: BinomiallyExtendable<D>,
{
    fn product<I: Iterator<Item = Self>>(iter: I) -> Self {
        let one = Self { value: field_to_array::<AF, D>(AF::one()) };
    ...
    for BinomialExtensionField<F, D>
{
    ...
    fn two_adic_generator(bits: usize) -> Self {
        Self { value: F::ext_two_adic_generator(bits) }
    }
}
